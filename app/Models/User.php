...
class User extends Authenticatable
{
    ...
    {
        return $this->belongsToMany(User::class, 'user_followers', 'following_id', 'followers_id');
    }

    public function following()
    {
        return $this->belongsToMany(User::class, 'user_followers', 'followers_id', 'following_id');
    }
    ...
    public function scopeNearby($query, $lat, $lon)
    {
        $radius = 10;
