                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('page.store') }}" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input id="title" type="text"
                                            ...
                                            name="title" value="{{ old('title') }}" placeholder="Full Name">
                                        @if ($errors->has('title'))
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="page_type">Page Type <span
                                                class="text-danger asteric-sign">&#42;</span></label>
                                        <select class="form-control {{ $errors->has('page_type') ? ' is-invalid' : '' }}"
                                            id="page_type" name="page_type">
                                            <option value="">Select Page Type</option>
                                            @foreach ($pageTypes as $key => $value)
                                                <option
                                                    value="{{ $key }}"{{ old('page_type') == $key ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-12">
                                    <input id="createdBy" type="hidden" class="form-control" name="created_by"
                                        value="{{ Auth::user()->id }}" placeholder="created by">
